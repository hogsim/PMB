...
// +-------------------------------------------------+
// $Id: perso.inc.php,v 1.11.6.1 2014-07-04 14:25:34 mbertin Exp $
...
$nbr_lignes=0;
$resultat2="";
if($resultat_count && $requete && mysql_num_rows($resultat_count)){
	$nbr_lignes=@mysql_result($resultat_count,0,0);
	$resultat2=mysql_query($requete);
}

if($resultat2 && mysql_num_rows($resultat2)){
	while($r=mysql_fetch_row($resultat2)) {
