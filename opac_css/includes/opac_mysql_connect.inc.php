...
// +-------------------------------------------------+
// $Id: opac_mysql_connect.inc.php,v 1.10.12.1 2015-01-21 09:17:46 mbertin Exp $
...
if ( ! defined( 'DB_CONNECT' ) ) {
  define( 'DB_CONNECT', 1 );
	...
	function connection_mysql($er_connec=1, $my_bd='', $bd=1, $er_bd=1) 	{
		...
		if (isset($time_zone_mysql) && trim($time_zone_mysql)) mysql_query("SET time_zone = $time_zone_mysql",$my_connec);//Pour l'heure MySQL
		return $my_connec;
	}
